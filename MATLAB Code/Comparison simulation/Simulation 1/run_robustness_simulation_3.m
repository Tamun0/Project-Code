function run_robustness_simulation_3()
    ...
    % Droop (modeled as a low-inertia VSM for stability, as per user's insight)
    P.J_droop = 0.2; 
    P.D_droop = 5.0; 
...
function dxdt = unified_dynamics(t, x, P, control_mode)
    ...
    switch control_mode
        case 'Droop'
            % FIX: Use the stable, low-inertia VSM model for Droop
